...
binary gaps: one of length 4 and one of length 3. The number 20 has binary r
epresentation 10100 and contains one binary gap of length 1. The number 15 has
...
/*
Solution 1: Do a bitwise & with 1 and check if the result is 0 or 1
            right shift the number to get next bit
Runtime : O(Log N) -> number of bits
Space : O(1)
*/
